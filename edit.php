        ...
        <div class="row">
            <div class="col-md-12 col-xl-8 offset-xl-2">
                ...
                <form name="form" action="" method="POST">
                    ...
                    <input name="titolo_pagina" class="form-control" type="text"
                        value="<?php echo htmlspecialchars($text4); ?>" style="width: 100%; margin-bottom:10px;">
                    <h1 style="font-size:16px; font-weight:500;">Profile picture</h1>
                    <input name="immagine" class="form-control" type="text"
                        value="<?php echo htmlspecialchars($text3); ?>" style="width: 100%; margin-bottom:10px;">
                    <h1 style="font-size:16px; font-weight:500;">Page title</h1>
                    <input name="titolo" class="form-control" type="text" value="<?php echo htmlspecialchars($text); ?>"
                        style="width: 100%; margin-bottom:10px;">
                    <h1 style="font-size:16px; font-weight:500;">Body text</h1>
                    <textarea id="mytextarea" rows="12" name="corpo" class="form-control"
                        style="width: 100%;"><?php echo htmlspecialchars($text2); ?></textarea>
                    </br>
                    <h1 style="font-size:16px; font-weight:500;">Custom CSS</h1>
                    <textarea rows="8" name="custom" class="form-control"
                        style="width: 100%;"><?php echo htmlspecialchars($text5); ?></textarea>
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                ...
                                <form class="d-flex flex-column" method="post" action="changepassword.php">
                                    ...
                                    <input placeholder="Insert here your old password" class="form-control"
                                        type="password" id="oldpassword" name="oldpassword" maxlength="10"
                                        pattern="[^(){}/><\][\\\x22,;|]+">
                                    <input placeholder="Insert here your new password" class="form-control"
                                        type="password" id="newpassword" name="newpassword" style="margin-top: 15px;"
                                        minlength="4" maxlength="10" pattern="[^(){}/><\][\\\x22,;|]+">
                                    <button class="btn btn-dark" type="submit" style="margin-top: 15px;">Change my
                                        password</button>
                                </form>

                                <!--Second option-->
                                <form class="d-flex flex-column" method="post" action="folder.php"
                                    style="margin-top: 35px;">
                                    <p>Generate new text folder. If you want to start your site from scratch delete TEXT
                                        folder, login into your dashboard and click this button.</p>
                                    <button class="btn btn-dark" type="submit">Regenerate text folder</button>
                                </form>
